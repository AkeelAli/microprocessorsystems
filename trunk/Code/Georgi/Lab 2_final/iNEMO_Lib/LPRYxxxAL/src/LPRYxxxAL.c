...
void LPRYxxxAL_Read_Rate(s16* out)
{
  ...
  out[0]=(s16)((outADC[0]-outADC[2])/Gyro_SensitivityLSB_PR);
  out[1]=-(s16)((outADC[1]-outADC[2])/Gyro_SensitivityLSB_PR);
  out[2]=(s16)((outADC[3]-outADC[4])/Gyro_SensitivityLSB_Yaw);
